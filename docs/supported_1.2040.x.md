...
|Create |    | :heavy_check_mark: |   | `Vecu8` init <br/>`Compactu128` amount <br/>`Compactu64` gas_limit <br/>`Compactu32` storage_limit <br/>`VecAccessListItem` access_list <br/> |
|Create2 |    | :heavy_check_mark: |   | `Vecu8` init <br/>`H256` salt <br/>`Compactu128` amount <br/>`Compactu64` gas_limit <br/>`Compactu32` storage_limit <br/>`VecAccessListItem` access_list <br/> |
|Create nft contract |    |   |   | `Vecu8` init <br/>`Compactu128` amount <br/>`Compactu64` gas_limit <br/>`Compactu32` storage_limit <br/>`VecAccessListItem` access_list <br/> |
|Create predeploy contract |    |   |   | `EvmAddress` target <br/>`Vecu8` init <br/>`Compactu128` amount <br/>`Compactu64` gas_limit <br/>`Compactu32` storage_limit <br/>`VecAccessListItem` access_list <br/> |
